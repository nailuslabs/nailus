...
describe('Config', () => {
  ...
  it('does not generate non-prefixed classes when using prefix', () => {
    ...
    const classes = 'items-center justify-center flex-wrap block flex nailus-block nailus-py-3 py-3 container aspect-none';
  ...
  it('allows to use prefix with shortcuts', () => {
    ...
    const result = processor.interpret('nailus-btn nailus-btn-green');
